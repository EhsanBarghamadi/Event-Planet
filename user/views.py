        ...
        request=inline_serializer(
            ...
            fields={
                "refresh": serializers.CharField(
                    help_text="توکن ریفرش برای بلک‌لیست شدن"
                )
            },
        ),
        responses={
            ...
            400: inline_serializer(
                name="LogoutErrorResponse", fields={"error": serializers.CharField()}
            ),
        },
    )
    ...
    @extend_schema(
        responses={
            200: inline_serializer(
                name="SessionLogoutResponse", fields={"detail": serializers.CharField()}
            )
        }
    )
    def post(self, request, *args, **kwargs):
