...
class Event(SluggedModel):
    ...
    description = models.TextField(verbose_name="توضیحات رویداد", blank=True, null=True)
    ...
    def clean(self):
        ...
        if self.capacity is not None and self.capacity <= 0:
            raise ValidationError({"capacity": "ظرفیت رویداد باید بزرگتر از صفر باشد."})
...
class EventStage(TimeStampedModel):
    ...
    description = models.TextField(verbose_name="توضیحات مرحله", blank=True, null=True)
